...
namespace WebApi.ServiceReference {
    ...
    public interface IService {
        ...
        WebApi.ServiceReference.Cheque[] GetChequesPack(int packSize);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetChequesPack", ReplyAction="http://tempuri.org/IService/GetChequesPackResponse")]
        System.Threading.Tasks.Task<WebApi.ServiceReference.Cheque[]> GetChequesPackAsync(int packSize);
        ...
        void SaveCheque(WebApi.ServiceReference.Cheque cheque);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/SaveCheque", ReplyAction="http://tempuri.org/IService/SaveChequeResponse")]
        System.Threading.Tasks.Task SaveChequeAsync(WebApi.ServiceReference.Cheque cheque);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChannel : WebApi.ServiceReference.IService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceClient : System.ServiceModel.ClientBase<WebApi.ServiceReference.IService>, WebApi.ServiceReference.IService {
        ...
        public WebApi.ServiceReference.Cheque[] GetChequesPack(int packSize) {
            return base.Channel.GetChequesPack(packSize);
        }
        
        public System.Threading.Tasks.Task<WebApi.ServiceReference.Cheque[]> GetChequesPackAsync(int packSize) {
            return base.Channel.GetChequesPackAsync(packSize);
        }
        
        public void SaveCheque(WebApi.ServiceReference.Cheque cheque) {
            base.Channel.SaveCheque(cheque);
        }
        
        public System.Threading.Tasks.Task SaveChequeAsync(WebApi.ServiceReference.Cheque cheque) {
